    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Santri</h2>
                    <a href="/data-santri/tambah" class="btn btn-sm btn-primary ml-5">Tambah</a>
                              ...
                              <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>{{ $item->kriteria->jujur }}</td>
                                    <td>{{ $item->kriteria->wibawa }}</td>
                                    <td>{{ $item->kriteria->hafalan_imriti }}</td>
                                    <td>{{ $item->kriteria->tangkas }}</td>
                                    <td>{{ $item->kriteria->ulet }}</td>
                                    <td>{{ $item->kriteria->disiplin }}</td>
                                    <td class="d-flex">
                                      <a href="/data-santri/{{ $item->id }}/edit" class="btn btn-sm btn-primary"><i class="fa fa-pencil-square"></i></a>
                                      <form action="/data-santri/{{ $item->id }}/delete" method="post">
                                          @method('delete')
                                          @csrf
