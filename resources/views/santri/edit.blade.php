...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="x_content">
                <form class="form-label-left input_mask" action="/data-santri/{{ $santri->id }}/update" method="POST">
                    @csrf
                    <div class="form-group row">
                        <label class="col-form-label col-md-3 col-sm-3 ">Nama Santri</label>
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Nama Santri" name="nama" value="{{ $santri->nama }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input name="tanggal_lahir" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" value="{{ $santri->tanggal_lahir }}">
                            <script>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Jujur" name="jujur" value="{{ $santri->kriteria->jujur }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Wibawa" name="wibawa" value="{{ $santri->kriteria->wibawa }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Hafalan Imriti" name="hafalan_imriti" value="{{ $santri->kriteria->hafalan_imriti }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Tangkas" name="tangkas" value="{{ $santri->kriteria->tangkas }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Ulet" name="ulet" value="{{ $santri->kriteria->ulet }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Disiplin" name="disiplin" value="{{ $santri->kriteria->disiplin }}">
                        </div>
                    </div>
