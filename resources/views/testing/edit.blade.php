...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="x_content">
                <form class="form-label-left input_mask" action="/data-testing/{{ $testing->id }}/update" method="POST">
                    @csrf

                    <div class="form-group row">
                        <label class="col-form-label col-md-3 col-sm-3 ">Jujur</label>
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Jujur" name="jujur" value="{{ $testing->jujur }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Wibawa" name="wibawa" value="{{ $testing->wibawa }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Hafalan Imriti" name="hafalan_imriti" value="{{ $testing->hafalan_imriti }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Tangkas" name="tangkas" value="{{ $testing->tangkas }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Ulet" name="ulet" value="{{ $testing->ulet }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="text" class="form-control" placeholder="Disiplin" name="disiplin" value="{{ $testing->disiplin }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <select id="heard" class="form-control" required name="keterangan">
								...
								<option value="1" @if($testing->keterangan == 1) selected @endif>Ya</option>
								<option value="2" @if($testing->keterangan == 2) selected @endif>Tidak</option>
							</select>
                        </div>
                    </div>
